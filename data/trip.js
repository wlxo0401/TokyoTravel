      ...
      flow: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "가와구치코 유람선(天晴) · 호숫가 산책 — 09:00~16:30 약 30분 간격, 편도 20분 순환. 성인 1,000엔·어린이 500엔", place: "河口湖遊覧船", coords: { lat: 35.5057, lng: 138.7595 } },
            { text: "오시노하카이(忍野八海) — 후지산 용수로 유명한 마을. 가와구치코에서 버스로 더 가야 해서 오이시 공원과는 양자택일", place: "忍野八海", coords: { lat: 35.4536, lng: 138.8286 }, optional: true },
          ],
        },
        {
          kind: "move",
