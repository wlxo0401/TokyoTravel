  ...
  days: [
    {
      ...
      flow: [
        ...
        },
        {
          ...
          note: "점심 후보는 여러 곳 잡아둘 예정 — 줄 길거나 시간 안 맞으면 다른 후보로 이동.",
          items: [
            { text: "점심 후보①: とんかつ ゆたか (돈가스, 70년 전통, 타베로그 3.61) — TX 아사쿠사역 도보 5분. 우리 시간대엔 예약 안 돼서 줄서야 할 수도 있음", place: "とんかつ ゆたか", coords: { lat: 35.7117706, lng: 139.7940958 }, optional: true },
            { text: "⚠️ 점심 후보②: とん久 돈가스 — 목요일 휴무인데 1일차(9/10)가 목요일이라 이날은 문 닫음. 타베로그 3.37, 가미나리몬 바로 옆(도부 아사쿠사역 도보 1분), 예약 불가, 카드 안 됨. 영업일에 다시 오거나 다른 후보로", place: "とん久", coords: { lat: 35.7112046, lng: 139.796664 }, optional: true },
    ...
    },
    {
      ...
      flow: [
        ...
        },
        {
          ...
          items: [
            { text: "후지산 파노라마 로프웨이 (텐조야마 전망대) — 왕복 1,000엔, 편도 3분+정상 30~40분+대기 포함 체류 1~1.5시간. 주말·성수기 대기 30분~1시간. 정상 단고(경단) 먹으며 인증샷. 줄 길면 옆 텐조야마 산책로(아지사이 하이킹코스)로 도보 30~40분", place: "富士山パノラマロープウェイ", coords: { lat: 35.5045, lng: 138.7626 }, optional: true },
            { text: "가와구치코 유람선(天晴) — 성인 1,000엔·어린이 500엔, 편도 20분 순환, 09:00~16:30 약 30분 간격. 로프웨이 선착장 바로 옆이라 묶어서 이용 좋음. 2층 야외 테라스석 추천", place: "河口湖遊覧船", coords: { lat: 35.5057, lng: 138.7595 }, optional: true },
            { text: "오이시 공원(大石公園) — 무료, 체류 1~1.5시간. 역에서 레드라인 버스 약 25분. 계절 꽃(라벤더·코스모스·댑싸리)+호수+후지산 뷰. 옆 '하나테라스'에서 후지산 모양 소프트크림", place: "大石公園 Oishi Park", coords: { lat: 35.5252, lng: 138.7566 }, optional: true },
            { text: "자전거 대여 호수 라이딩 — 일반 1시간 약 600엔·하루 1,500~2,000엔, 전기자전거 1시간 약 1,000엔·하루 2,500~3,000엔. 오르막 있어 전기자전거 추천. 버스 안 기다리고 원하는 곳마다 정차 가능", optional: true },
